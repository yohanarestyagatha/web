        ...
        <div class="content-area">
            ...
            <div class="content-area-inner">
                ...
                <section id="intro">
                    ...
                    <div class="container-mid">
                        ...
                        <div class="animation-container animation-fade-down" data-animation-delay="0">
                            ...
                            <h1>Saya Yohana Resty Agatha</h1>
                        ...
                        <div class="animation-container animation-fade-left" data-animation-delay="300">
                            ...
                            <p class="subline">Hai selamat datang di cv saya, saya adalah seorang mahasiswa tingkat dua di Politeknik Kampar dengan program studi Teknik Informatika, saya gemar melakukan design di bidang animasi.</p>
                ...
                <section id="about">
                    ...
                    <h3 class="headline scroll-animated-from-right">Work Experience.</h3>
                    
                    <p class="scroll-animated-from-right"> 1. Memberikan tutor privat matematika untuk siswa sekolah dasar
                    </p>

                    <p class="scroll-animated-from-right"> 2. Freelancer Design Grafis</p>

                    <p class="scroll-animated-from-right"> 3. Freelancer konten kreator</p>
